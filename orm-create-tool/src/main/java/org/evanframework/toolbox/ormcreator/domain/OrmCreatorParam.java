...
public class OrmCreatorParam {
	...
	private String outDir = "evan-ormcreator-output";
	...
	public String toString() {
		return "OrmCreatorParam [ormType=" + ormType + ", databaseType=" + databaseType + ", jdbcDriverClassName="
				+ jdbcDriverClassName + ", jdbcUrl=" + jdbcUrl + ", jdbcUser=" + jdbcUser + ", jdbcPassword="
				+ jdbcPassword + ", packageNamePo=" + packageNamePo + ", packageNameDao=" + packageNameDao
				+ ", packageNameMapper=" + packageNameMapper + ", packageNameQuery=" + packageNameQuery
				+ ", basePoName=" + basePoName + ", baseQueryClass=" + baseQueryClass + ", queryInterface="
				+ queryInterface + ", baseDaoName=" + baseDaoName + ", baseMapperName=" + baseMapperName + ", outDir="
				+ outDir + ", templateDir=" + templateDir + ", prefixRemove=" + prefixRemove + ", deletedTagValueYes="
				+ deletedTagValueYes + ", deletedTagValueNo=" + deletedTagValueNo + ", deletedTagColumn="
				+ deletedTagColumn + ", statusColumn=" + statusColumn + ", encoding=" + encoding
				+ ", dataTypeConvertor=" + dataTypeConvertor + ", tables=" + tables + ", databaseTypeClassName="
